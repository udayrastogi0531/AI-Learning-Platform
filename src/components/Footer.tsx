  ...
  return (
    <footer className="bg-background text-foreground border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-white/10 mt-10 pt-6 text-sm text-foreground-secondary flex flex-col md:flex-row justify-between items-center gap-3">
          <span>© {currentYear} NeuroLearn. All rights reserved. • AI Learning OS</span>
          
          <div className="flex items-center space-x-6 text-sm text-gray-400">
            <span className="flex items-center">
              Made with <Heart className="w-4 h-4 text-red-500 mx-1 fill-red-500" /> for learners worldwide
            </span>
